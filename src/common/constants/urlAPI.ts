export const BASE_URL =
  process.env.REACT_APP_API_URL || "http://vief-dev-loadbalancer-2024646.ap-southeast-1.elb.amazonaws.com";
...
export const POLICY_CATEGORY = "client/category?type=POLICY&field=WOOD&isFeature=1";
