...
const Subcribe = () => {
  return (
    <>
      ...
      >
        <Box w="48%" h="444px">
          <Image src="/researchIMG.png" w="592px" h="444px" objectFit={"cover"} borderRadius={"12px"} alt=""></Image>
        </Box>
        <Stack
          spacing="32px"
          w={{
      ...
      >
        ...
        >
          <Stack spacing="16px">
            <Text variant={{ md: "text28", sm: "text24" }}>Đăng ký nhận tin</Text>
            <Text variant="text14">
          ...
          <Box w="100%" h="257.25px">
            <Image src="/researchIMG.png" w="full" h="full" objectFit={"cover"} borderRadius={"12px"} alt=""></Image>
          </Box>
